...
export function TitleSlide() {
  return (
    <Slide className="bg-background">
      <div
        className="absolute inset-0 -z-10 bg-no-repeat opacity-20"
        style={{
      ...
      <div className="z-10 flex flex-col items-center gap-8 text-center">
        ...
        <p className="text-2xl font-semibold text-foreground md:text-3xl lg:text-4xl">
        ...
        <div className="mt-8 rounded-base border-4 border-foreground bg-card px-8 py-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <p className="text-lg font-bold text-card-foreground">Built by soko.eth</p>
        </div>
      </div>
    </Slide>
  );
...
export function ProblemSlide() {
  return (
    <Slide className="bg-background">
      <div
        className="absolute inset-0 -z-10 bg-no-repeat opacity-10"
        style={{
          backgroundImage: "url('/simpsons-1600x900.png')",
          backgroundSize: "cover",
          backgroundPosition: "center",
          ...
          <CardContent className="space-y-6 text-lg md:text-xl">
            ...
            <div className="mt-8 rounded-base border-4 border-foreground bg-secondary-background p-6">
              <p className="font-bold">
                Especially problematic for TEE environments like Eigen Compute where frequent
                updates hurt trust and verifiability
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6 text-lg md:text-xl">
            <div className="space-y-4">
              ...
              <div className="rounded-base border-4 border-foreground bg-main p-6">
                <p className="font-mono text-lg font-bold text-main-foreground">@BartMart.sol</p>
              </div>
            </div>
        ...
        <Card className="border-4">
          ...
          <CardContent className="space-y-6 text-lg md:text-xl">
            <div className="space-y-6">
              <p className="text-2xl font-bold">Agents deployed to TEEs with one simple trading tool</p>
              <div className="rounded-base border-4 border-foreground bg-main p-6">
                <p className="font-mono text-lg font-bold text-main-foreground">
